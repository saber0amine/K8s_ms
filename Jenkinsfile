...
//                         docker.image("${REGISTRY}/geteway-service:0.0.1").push()
  ...
  kubectl delete -f  kubernetes-Manifests/Springboot-k8s-main/keycloak-service.y
                kubectl apply -f  kubernetes-Manifests/Springboot-k8s-main/keycloak-service.y
